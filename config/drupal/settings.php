 ...
 */
// Use environment variable for trusted host patterns
...
// Enable custom services definitions
if (file_exists("$config_path/drupal.services.yml")) {
  $settings['container_yamls'][] = "$config_path/drupal.services.yml";
}
